        ...
        <Card className="bg-blue-50 border-blue-200">
          <CardHeader className="pb-2 sm:pb-3">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm sm:text-base md:text-lg text-blue-800">
            ...
            <div className="flex flex-wrap gap-1 sm:gap-2">
              {activeFilters.map((filter, index) => (
                <Badge
                  key={index}
                  variant="default"
                  className="text-xs sm:text-sm px-2 py-1 sm:px-3 bg-blue-600 text-white hover:bg-blue-700 cursor-pointer transition-all duration-200 group"
                  onClick={() => {
                    // Remove this specific filter
                    const newFilters = { ...filters };
                    if (Array.isArray(newFilters[filter.key])) {
                      newFilters[filter.key] = [];
                    } else if (typeof newFilters[filter.key] === "boolean") {
              ...
              <CardContent className="pt-4 sm:pt-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-1.5 mt-2">
                      {[
                        ...
                        { value: "endUserName", label: "Customer", icon: "👤" },
                        {
                          value: "contactPerson",
                          label: "Contact",
                          icon: "📞",
                  ...
                  <div className="space-y-2 sm:col-span-2">
                    ...
                    <div className="flex flex-wrap gap-2 mt-2">
                      {[
                        ...
                        { value: "exact", label: "Exact Match", icon: "🎯" },
                        {
                          value: "startsWith",
                          label: "Starts With",
                          icon: "▶️",
                        },
                        { value: "endsWith", label: "Ends With", icon: "◀️" },
                      ].map((mode) => (
                        <Badge
                          key={mode.value}
                          variant={
                    ...
                    <div className="flex flex-wrap gap-2 mt-2">
                      {[
                        ...
                        <Badge
                          ...
                          onClick={() =>
                            handleFilterChange("orderBy", sortOption.value)
                          }
                        >
                ...
                <div className="mt-3 sm:mt-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Badge
                      variant={filters.exactMatch ? "default" : "outline"}
                      className={`cursor-pointer transition-all duration-200 hover:scale-105 text-xs sm:text-sm px-3 py-1.5 ${
                        filters.exactMatch
                      ...
                      onClick={() =>
                        handleFilterChange("exactMatch", !filters.exactMatch)
                      }
                    >
                      <span className="mr-1.5">🎯</span>
                      Exact Match
                      {filters.exactMatch && <X className="w-3 h-3 ml-1.5" />}
                    </Badge>
            ...
            <Card>
              <CardContent className="pt-4 sm:pt-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  ...
                  <div className="space-y-2 sm:col-span-2">
                    <Label htmlFor="lastNDays" className="text-xs sm:text-sm">
                      Last N Days
                    </Label>
                    <Input
                      id="lastNDays"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="salesDateFrom">Sales Date From</Label>
                    <DatePicker
                ...
                <div className="mt-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[
                      ...
                      <Badge
                        key={item.key}
                        variant={filters[item.key] ? "default" : "outline"}
                        className={`cursor-pointer transition-all duration-200 hover:scale-105 text-xs sm:text-sm px-3 py-1.5 ${
                          filters[item.key]
                        ...
                        onClick={() =>
                          handleFilterChange(item.key, !filters[item.key])
                        }
                      >
                        {item.label}
                        {filters[item.key] && <X className="w-3 h-3 ml-1.5" />}
                      </Badge>
                    ))}
                  </div>
                </div>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleFilterChange("amountExact", e.target.value)
                      }
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="stoveSerialNo">Stove Serial Number</Label>
                    <Input
                      id="stoveSerialNo"
                ...
                <div className="mt-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[
                      { key: "hasLocation", label: "Has Location", icon: "📍" },
                      { key: "hasContact", label: "Has Contact", icon: "📞" },
                      { key: "hasAmount", label: "Has Amount", icon: "💰" },
                      { key: "hasStatus", label: "Has Status", icon: "📊" },
                      { key: "isActive", label: "Is Active", icon: "✅" },
                    ].map((item) => (
                      <Badge
                        key={item.key}
                        variant={
                          filters[item.key] === true ? "default" : "outline"
                        }
                        className={`cursor-pointer transition-all duration-200 hover:scale-105 text-xs sm:text-sm px-3 py-1.5 ${
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="flex flex-wrap gap-2 mt-2">
                      {[
                        ...
                        <Badge
                          ...
                          onClick={() =>
                            handleFilterChange("exportFormat", format.value)
                          }
                        >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2 mt-2">
                      {[
                        { value: "asc", label: "Ascending", icon: "⬆️" },
                        { value: "desc", label: "Descending", icon: "⬇️" },
                      ].map((order) => (
                        <Badge
                          key={order.value}
                          variant={
                          ...
                          onClick={() =>
                            handleFilterChange("orderDirection", order.value)
                          }
                        >
                ...
                <div className="mt-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[
                      { key: "skipCache", label: "Skip Cache", icon: "⚡" },
