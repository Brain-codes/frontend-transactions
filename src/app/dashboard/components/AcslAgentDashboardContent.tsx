...
function buildPartnerStats(partners: any[], _salesInRange: SaleRecord[]): PartnerStats[] {
  return partners
    .map((p) => ({
      ...p,
...
const AcslAgentDashboardContent = () => {
  ...
  useEffect(() => {
    ...
    const fetchAll = async () => {
      ...
      const [statsRes, orgsRes, rangeRes, pendingRes] = await Promise.allSettled([
      ...
      if (orgsRes.status === "fulfilled") setPartners(orgsRes.value.data || []);
          ...
          <>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-blue-900">{(stats?.totalSales ?? 0).toLocaleString()}</p>
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-green-900">{(stats?.approvedSales ?? 0).toLocaleString()}</p>
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-amber-900">{(stats?.pendingApprovals ?? 0).toLocaleString()}</p>
              ...
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-purple-900">{approvalRate}%</p>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-blue-900">{(stats?.assignedPartnersCount ?? partners.length).toLocaleString()}</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
              <div className="lg:col-span-3 bg-white shadow-none border border-gray-200 rounded-lg p-4">
                <p className="text-sm font-semibold text-gray-700 mb-3">Sales Activity — Last 14 Days</p>
            ...
            {partnerStats.length > 0 && (
              <div className="space-y-3">
                ...
                {partnerStats.length > 6 && (
                  <Link href="/partners" className="text-sm text-brand font-medium flex items-center gap-1 mt-1 hover:underline">
            ...
            <div className="flex flex-wrap gap-3">
              {([
                { label: "View All Sales", href: "/sales", Icon: FileText },
                { label: "Stove IDs", href: "/stove-management", Icon: Package },
                { label: "My Partners", href: "/partners", Icon: Building2 },
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  {pendingQueue.length === 0 ? (
                    ...
                    <Link href="/sales?approval=pending" className="flex items-center gap-1 text-xs font-medium text-brand hover:underline">
