      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="hover:shadow-lg transition-shadow border-l-4 border-l-blue-500">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-gray-900">Live Data</div>
          ...
          <Card className="hover:shadow-lg transition-shadow border-l-4 border-l-orange-500">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-gray-900">Focused</div>
              <p className="text-xs text-gray-600 mt-1">
          ...
          <Card className="col-span-1">
            ...
            <CardContent className="space-y-4">
              <p className="text-gray-600">
                Access your complete sales management system with real-time data
                integration.
              </p>
          ...
          <CardContent className="p-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  Access comprehensive sales management with real-time data
                  integration.
                </p>
              </div>
              <Button
