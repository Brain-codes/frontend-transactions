...
import { SUPER_ADMIN_ENDPOINTS, AUTH_REQUIREMENTS, ERROR_RESPONSES } from "../constants/apiEndpoints";
import { 
  DOC_METADATA, 
  INTRO_CONTENT, 
  COMMON_SECTIONS, 
...
const SuperAdminDocumentation = () => {
  ...
  const EndpointSection = ({ title, endpoints, category, icon: Icon, description }) => {
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-4xl font-bold">Super Admin API Documentation</h1>
          </div>
        ...
        <Tabs defaultValue="overview" className="space-y-6">
          ...
          <TabsContent value="overview" className="space-y-6">
            <Card className="border-l-4 border-l-purple-500">
              ...
              <CardContent className="space-y-4">
                <div>
                  <h3 className="font-semibold mb-2">Super Admin API Overview</h3>
                  <p className="text-muted-foreground">{INTRO_CONTENT.overview}</p>
                </div>
                
                <div>
                  <h3 className="font-semibold mb-2">Cross-Organization Access</h3>
                  <p className="text-muted-foreground">
                    Super Admin APIs provide system-wide access across all partner organizations, 
                    comprehensive reporting capabilities, and advanced filtering options not available to regular admins.
                  </p>
                </div>
            ...
            <Card>
              ...
              <CardContent>
                <div>
                  <h3 className="font-semibold mb-2">{ROLE_DESCRIPTIONS.superAdmin.title}</h3>
                  <p className="text-muted-foreground mb-4">{ROLE_DESCRIPTIONS.superAdmin.description}</p>
                  
                  <h4 className="font-semibold mb-2">Key Capabilities:</h4>
                  <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                    {ROLE_DESCRIPTIONS.superAdmin.capabilities.map((capability, index) => (
              ...
              <CardContent>
                <div className="bg-amber-50 border border-amber-200 rounded p-4">
                  <p className="text-amber-800">
                    <strong>Super Admin Access:</strong> These endpoints provide system-wide access and should be used with caution. 
                    All super admin operations are logged and monitored for security purposes.
                  </p>
                </div>
              </CardContent>
            </Card>
          ...
          <TabsContent value="endpoints" className="space-y-6">
            <div className="mb-6">
              <h2 className="text-2xl font-bold mb-4">Super Admin API Endpoints</h2>
              <p className="text-muted-foreground">
                The following endpoints are available exclusively for super admin users. These APIs provide cross-organizational 
                access and advanced system management capabilities.
              </p>
            </div>
                ...
                <div className="space-y-4">
                  <div className="bg-purple-50 border border-purple-200 rounded p-4">
                    <p className="text-purple-800">
                      <strong>Important:</strong> Super Admin endpoints require additional role-based verification. 
                      Your JWT token must include the `super_admin` role claim.
                    </p>
                  </div>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="mt-4 text-sm text-muted-foreground">
                  <p><strong>Note:</strong> The JWT token must contain the `super_admin` role for these endpoints to work.</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div>
                    <h4 className="font-semibold">Super Admin Role Requirements:</h4>
                    <ul className="list-disc list-inside text-sm text-muted-foreground mt-2 space-y-1">
                      <li>User must have `role: "super_admin"` in their user profile</li>
                      <li>JWT token must include super admin claims</li>
                      <li>All requests are logged for security auditing</li>
                      <li>Rate limiting may be more restrictive for super admin endpoints</li>
                    </ul>
                  </div>
                </div>
              </CardContent>
...
const getSalesData = async () => {
  ...
  return result;
                ...
                <div>
                  <h3 className="font-semibold mb-3">Organization Management</h3>
                  <pre className="bg-muted p-4 rounded text-sm overflow-x-auto">
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="border-l-4 border-l-purple-500 pl-4">
                    ...
                    <p className="text-muted-foreground">Always verify user permissions before making super admin API calls. Log all operations for audit purposes.</p>
                  </div>
                  
                  <div className="border-l-4 border-l-purple-500 pl-4">
                    <h3 className="font-semibold">Performance Optimization</h3>
                    <p className="text-muted-foreground">Use pagination and filtering for large datasets. Super admin endpoints can return massive amounts of data.</p>
                  </div>

                  <div className="border-l-4 border-l-purple-500 pl-4">
                    <h3 className="font-semibold">Data Export</h3>
                    <p className="text-muted-foreground">Use the export parameter judiciously. Large exports can impact system performance.</p>
                  </div>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="mt-4 bg-purple-50 border border-purple-200 rounded p-4">
                  <h4 className="font-semibold text-purple-800 mb-2">Super Admin Additional Filters:</h4>
                  <ul className="list-disc list-inside text-purple-700 space-y-1">
                    <li><code>organization_id</code>: Filter by specific organization</li>
                    <li><code>export</code>: Enable CSV export functionality</li>
                    <li><code>include_deleted</code>: Include soft-deleted records</li>
                    <li><code>aggregate</code>: Return summary statistics</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="border rounded p-4 bg-red-50 border-red-200">
                    <h3 className="font-semibold text-red-600 mb-2">403 Forbidden - Insufficient Permissions</h3>
                    <p className="text-muted-foreground">
                      Even with a valid token, you might get 403 if your account doesn't have super_admin role. 
                      Contact your system administrator to verify your account permissions.
                    </p>
                  </div>

                  <div className="border rounded p-4 bg-red-50 border-red-200">
                    <h3 className="font-semibold text-red-600 mb-2">Large Dataset Timeouts</h3>
                    <p className="text-muted-foreground">
                      Super admin queries can return large amounts of data. Use pagination and filters to reduce response size. 
                      Consider using the export functionality for large data extractions.
                    </p>
                  </div>

                  <div className="border rounded p-4 bg-red-50 border-red-200">
                    <h3 className="font-semibold text-red-600 mb-2">Rate Limiting</h3>
                    <p className="text-muted-foreground">
                      Super admin endpoints may have stricter rate limiting. Implement proper retry logic with exponential backoff.
                    </p>
                  </div>
                </div>
              </CardContent>
