...
[
  {
    ...
    "Constraints": "super_admin_agent_organizations_pkey (PRIMARY KEY), 2200_286951_3_not_null (CHECK), 2200_286951_2_not_null (CHECK), 2200_286951_5_not_null (CHECK), 2200_286951_1_not_null (CHECK), 2200_286951_4_not_null (CHECK), super_admin_agent_organizations_agent_id_fkey (FOREIGN KEY), super_admin_agent_organizations_agent_id_organization_id_key (UNIQUE), super_admin_agent_organizations_assigned_by_fkey (FOREIGN KEY), super_admin_agent_organizations_organization_id_fkey (FOREIGN KEY)",
  ...
  },
  {
    ...
    "Constraints": "super_admin_agent_states_agent_id_fkey (FOREIGN KEY), 2200_299988_1_not_null (CHECK), 2200_299988_3_not_null (CHECK), 2200_299988_2_not_null (CHECK), 2200_299988_4_not_null (CHECK), 2200_299988_5_not_null (CHECK), super_admin_agent_states_pkey (PRIMARY KEY), super_admin_agent_states_assigned_by_fkey (FOREIGN KEY), super_admin_agent_states_agent_id_state_key (UNIQUE)",
    "Policies": "agent_read_own [PERMISSIVE] (SELECT), super_admin_full_access [PERMISSIVE] (ALL)"
  },
  {
  ...
  },
  {
    ...
    "Constraints": "2200_174780_5_not_null (CHECK), 2200_174780_4_not_null (CHECK), 2200_174780_3_not_null (CHECK), 2200_174780_1_not_null (CHECK), fk_credentials_profile (FOREIGN KEY), credentials_email_key (UNIQUE), credentials_user_id_fkey (FOREIGN KEY), credentials_pkey (PRIMARY KEY), credentials_partner_id_key (UNIQUE), credentials_organization_id_fkey (FOREIGN KEY)",
  ...
  },
  {
    ...
    "Constraints": "2200_157828_2_not_null (CHECK), external_app_tokens_pkey (PRIMARY KEY), 2200_157828_4_not_null (CHECK), 2200_157828_3_not_null (CHECK), external_app_tokens_token_key (UNIQUE), 2200_157828_1_not_null (CHECK)",
    "Policies": "-"
  },
  {
    ...
    "Constraints": "installment_payments_sale_id_fkey (FOREIGN KEY), installment_payments_payment_method_check (CHECK), installment_payments_pkey (PRIMARY KEY), installment_payments_proof_image_id_fkey (FOREIGN KEY), installment_payments_recorded_by_fkey (FOREIGN KEY), 2200_301166_1_not_null (CHECK), 2200_301166_2_not_null (CHECK), 2200_301166_3_not_null (CHECK), 2200_301166_4_not_null (CHECK), 2200_301166_8_not_null (CHECK), 2200_301166_9_not_null (CHECK), 2200_301166_10_not_null (CHECK)",
  ...
  },
  {
    ...
    "Constraints": "2200_301138_2_not_null (CHECK), 2200_301138_5_not_null (CHECK), 2200_301138_4_not_null (CHECK), 2200_301138_3_not_null (CHECK), organization_payment_models_organization_id_fkey (FOREIGN KEY), organization_payment_models_pkey (PRIMARY KEY), organization_payment_models_payment_model_id_fkey (FOREIGN KEY), organization_payment_models_assigned_by_fkey (FOREIGN KEY), organization_payment_models_organization_id_payment_model_i_key (UNIQUE), 2200_301138_1_not_null (CHECK)",
  ...
  },
  {
    ...
    "Constraints": "organizations_updated_by_fkey (FOREIGN KEY), organizations_created_by_fkey (FOREIGN KEY), 2200_21282_17_not_null (CHECK), 2200_21282_8_not_null (CHECK), 2200_21282_5_not_null (CHECK), 2200_21282_1_not_null (CHECK), organizations_partner_type_check (CHECK), organizations_pkey (PRIMARY KEY)",
  ...
  },
  {
    ...
    "Constraints": "2200_301116_7_not_null (CHECK), payment_models_created_by_fkey (FOREIGN KEY), payment_models_pkey (PRIMARY KEY), 2200_301116_8_not_null (CHECK), 2200_301116_9_not_null (CHECK), 2200_301116_5_not_null (CHECK), 2200_301116_4_not_null (CHECK), 2200_301116_2_not_null (CHECK), 2200_301116_1_not_null (CHECK), 2200_301116_10_not_null (CHECK)",
    "Policies": "super_admin_full_access [PERMISSIVE] (ALL), authenticated_read_active [PERMISSIVE] (SELECT)"
  },
  {
    "Table Name": "profiles",
    "Columns": "id (uuid), created_at (timestamp with time zone), email (text), full_name (text), phone (text), role (text), has_changed_password (boolean), organization_id (uuid), username (text), status (text), last_login (timestamp with time zone), updated_at (timestamp with time zone), updated_by (uuid)",
    "Constraints": "profiles_organization_id_fkey (FOREIGN KEY), profiles_pkey (PRIMARY KEY), profiles_updated_by_fkey (FOREIGN KEY), profiles_username_key (UNIQUE), profiles_email_key (UNIQUE), 2200_18513_2_not_null (CHECK), profiles_status_check (CHECK), 2200_18513_1_not_null (CHECK)",
    "Policies": "allow_profile_creation [PERMISSIVE] (INSERT), users_read_own_profile [PERMISSIVE] (SELECT), users_update_own_profile [PERMISSIVE] (UPDATE), service_role_access [PERMISSIVE] (ALL)"
  },
  {
    "Table Name": "sales",
    ...
    "Constraints": "2200_22627_22_not_null (CHECK), 2200_22627_26_not_null (CHECK), sales_address_id_fkey (FOREIGN KEY), sales_agent_approved_by_fkey (FOREIGN KEY), sales_agreement_image_id_fkey (FOREIGN KEY), 2200_22627_1_not_null (CHECK), sales_organization_id_fkey (FOREIGN KEY), sales_payment_model_id_fkey (FOREIGN KEY), sales_payment_status_check (CHECK), sales_pkey (PRIMARY KEY), sales_status_check (CHECK), sales_stove_image_id_fkey (FOREIGN KEY), sales_created_by_fkey (FOREIGN KEY)",
    "Policies": "users_org_sales [PERMISSIVE] (SELECT), admin_org_sales_management [PERMISSIVE] (ALL), users_own_sales [PERMISSIVE] (ALL), super_admin_sales_access [PERMISSIVE] (ALL), service_role_access [PERMISSIVE] (ALL)"
  },
  {
    ...
    "Constraints": "sales_history_pkey (PRIMARY KEY), 2200_47750_4_not_null (CHECK), 2200_47750_3_not_null (CHECK), 2200_47750_2_not_null (CHECK), 2200_47750_1_not_null (CHECK), sales_history_sale_id_fkey (FOREIGN KEY), 2200_47750_6_not_null (CHECK), sales_history_performed_by_fkey (FOREIGN KEY)",
  ...
  },
  {
    ...
    "Constraints": "stove_ids_pkey (PRIMARY KEY), stove_ids_sale_id_check (CHECK), stove_ids_stove_id_organization_id_key (UNIQUE), stove_ids_sale_id_fkey (FOREIGN KEY), 2200_89506_4_not_null (CHECK), 2200_89506_3_not_null (CHECK), 2200_89506_2_not_null (CHECK), 2200_89506_1_not_null (CHECK), stove_ids_organization_id_fkey (FOREIGN KEY)",
  ...
  },
  {
    ...
    "Columns": "id (uuid), transaction_id (text), organization_id (uuid), partner_name (text), partner_id (text), state (text), branch (text), stove_count (integer), stove_ids (jsonb), source (text), application_name (text), transfer_date (timestamp with time zone), created_at (timestamp with time zone), sales_factory (text)",
    "Constraints": "2200_329161_13_not_null (CHECK), stove_transfer_history_source_check (CHECK), stove_transfer_history_pkey (PRIMARY KEY), stove_transfer_history_organization_id_fkey (FOREIGN KEY), 2200_329161_1_not_null (CHECK), 2200_329161_2_not_null (CHECK), 2200_329161_4_not_null (CHECK), 2200_329161_5_not_null (CHECK), 2200_329161_8_not_null (CHECK), 2200_329161_9_not_null (CHECK), 2200_329161_10_not_null (CHECK), 2200_329161_12_not_null (CHECK)",
  ...
  },
  {
    ...
    "Constraints": "2200_328971_3_not_null (CHECK), 2200_328971_18_not_null (CHECK), 2200_328971_1_not_null (CHECK), 2200_328971_2_not_null (CHECK), 2200_328971_5_not_null (CHECK), sync_logs_pkey (PRIMARY KEY), sync_logs_source_check (CHECK), sync_logs_status_check (CHECK)",
  ...
  },
  {
    ...
    "Policies": "users_own_uploads [PERMISSIVE] (ALL), super_admin_uploads_access [PERMISSIVE] (ALL), service_role_access [PERMISSIVE] (ALL)"
  }
]